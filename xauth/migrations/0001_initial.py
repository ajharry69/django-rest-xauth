    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deactivation_time', models.DateTimeField(blank=True, null=True, verbose_name="user account's deactivation time")),
                ('security_question', models.ForeignKey(default=xauth.models.default_security_question, on_delete=django.db.models.deletion.SET_DEFAULT, to='xauth.SecurityQuestion')),
            ],
        ),
    ]
