...
PASSWORD_LENGTH = 128
_SERIALIZERS = XAUTH.get('SERIALIZERS_CLASSES', {})
PROFILE_SERIALIZER = _SERIALIZERS.get('PROFILE', 'xauth.serializers.ProfileSerializer')
SIGN_UP_REQUEST_SERIALIZER_CLASSES = _SERIALIZERS.get('SIGN_UP_REQUEST', None)
# SIGN_IN_REQUEST_SERIALIZER_CLASSES = _SERIALIZERS.get('SIGN_IN_REQUEST', None)
