...
from xauth.apps.accounts.models import User
...
class UserTestCase(APITestCase):
    ...
    def test_is_verified_for_non_email_provider_or_superuser_and_or_staff_users(self):
        ...
        user3 = get_user_model().objects.create(
            email="user3@mail-domain.com", provider=enums.AuthProvider.EMAIL.name, is_staff=True
        )
        user4 = get_user_model().objects.create(
            email="user4@mail-domain.com",
    ...
    def test_creating_user_account_without_password_returns_empty_or_none_password(self):
        ...
        user1 = get_user_model().objects.create_user(
            email="user1@mail-domain.com", username="user1234", password=password1
        )
        user2 = get_user_model().objects.create_user(
            email="user2@mail-domain.com", username="user12345", password=password2
        )
        self.assertIsNotNone(user.password)
    ...
    def test_creating_superuser_without_password_raises_ValueError(self):
        with self.assertRaises(ValueError):
            get_user_model().objects.create_superuser(email="user@mail-domain.com", username="user123", password=None)
